// Package e2e provides comprehensive end-to-end testing for the v2 AgentPipe architecture.
//
// # Overview
//
// This package contains tests that verify the complete v2 stack works together correctly,
...
//
//	go test -tags e2e -v ./pkg/v2/e2e/...
//
// To run a specific test file:
//
//	go test -tags e2e -v ./pkg/v2/e2e/conversation_test.go
//
// To run tests with race detection:
//
//	go test -tags e2e -race -v ./pkg/v2/e2e/...
//
// To run benchmarks:
//
//	go test -tags e2e -bench=. -benchmem ./pkg/v2/e2e/...
//
// # Test Files
//
...
//
// Key components:
//   - TestHarness: Complete v2 stack with mock adapters
...
//
//	go test -tags e2e -coverprofile=coverage.out ./pkg/v2/...
